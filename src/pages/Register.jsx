...
export default function Register() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Full-screen clickable overlay — only when lights are off */}
      {!isAwake && (
        <button
      ...
      <div className="relative z-20 min-h-screen flex flex-col items-center justify-start pt-20 md:pt-16 px-6 pointer-events-none">
        {/* Moon — pointer-events-none so it doesn't block the overlay */}
                ...
                <AnimatePresence>
                  ...
                  {success && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, height: "auto" }}
                      exit={{ opacity: 0, height: 0 }}
                      className="flex items-start gap-2 p-3 mb-4 bg-green-500/10 border border-green-500/30 rounded-lg text-green-400 text-sm"
                    >
